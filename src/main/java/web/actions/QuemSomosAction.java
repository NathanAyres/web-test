...
public class QuemSomosAction extends BaseActions{

	public QuemSomosAction(WebDriver driver) {
		super(driver);
	}
	
	public void abrirMenu() {
		WebElement menuBlog = driver.findElement(By.xpath("//*[@id=\"menu-item-133\"]/a"));
		menuBlog.click();
